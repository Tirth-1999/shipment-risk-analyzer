...
Optional **Shipment Risk Analyser** demo & interview prep (not graded): see [`optional/README.md`](optional/README.md).

- Presentation script: [`optional/WALKTHROUGH.md`](optional/WALKTHROUGH.md)
- Q&A and reference: [`optional/QA.md`](optional/QA.md)
- Practice: `jupyter notebook optional/notebooks/interview_drills.ipynb`
- Demo: `jupyter notebook optional/notebooks/demo_shipment_walkthrough.ipynb` or `cd optional && streamlit run app.py`
